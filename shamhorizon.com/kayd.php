...
<? include('main-menu.php') ?>
    ...
    <?
        ...
        {
        case "show":
        include("template/kayd/show.php");
        break;
        case "add":
        include("template/kayd/add.php");
        break;
        case "edit":
        include("template/kayd/edit.php");
        break;
        case "details":
        include("template/kayd/details.php");
        break;
        case "send_message":
        include("template/kayd/send_message.php");
        break;
        case "send_all_message":
        include("template/kayd/send_all_message.php");
        break;
        }
