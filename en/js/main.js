        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: 25.1003354, //Replace Here Location Google Map Lat
                        lng: 55.1520413, //Replace Here Location Google Map Lng
                        scrollwheel: false,
                        zoom: 12,
                        zoomControl: true,
                        panControl: true,
                    ...
                    map.addMarker({
                        lat: 25.1003354, //Replace Here Location Google Map Lat
                        lng: 55.1520413, //Replace Here Location Google Map Lat
                        icon: image,
